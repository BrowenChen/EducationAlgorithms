...
#include "oscats_bindings_Plumbing.h"
...
Java_oscats_bindings_Plumbing_createPointer
(
	JNIEnv *env,
	jclass cls,
	jclass type,
 ...
 */
JNIEXPORT jobject JNICALL
Java_oscats_bindings_Plumbing_createFlag
(
	JNIEnv *env,
	jclass cls,
	jclass type,
...
Java_oscats_bindings_Plumbing_toHexString
(
	JNIEnv *env,
	jclass cls,
	jlong _pointer
