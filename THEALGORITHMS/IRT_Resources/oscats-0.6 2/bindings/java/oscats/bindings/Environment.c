...
#include "oscats_bindings_Environment.h"
...
Java_oscats_bindings_Environment_getenv
(
	JNIEnv *env,
	jclass cls,
	jstring _name
...
Java_oscats_bindings_Environment_setenv
(
	JNIEnv *env,
	jclass cls,
	jstring _name,
 ...
 */
JNIEXPORT void  JNICALL
Java_oscats_bindings_Environment_unsetenv
(
	JNIEnv *env,
	jclass cls,
	jstring _name
...
Java_oscats_bindings_Environment_getWidth
(
	JNIEnv *env,
	jclass cls
)
