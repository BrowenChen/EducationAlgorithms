...
/*
    public static Object new_with_params(Class<? extends Object> cls, java.lang.Object... params) {
        try
        {
          Class[] types = new Class[] { long.class };
          Constructor cons = cls.getDeclaredConstructor(types);
          java.lang.Object[] args = new java.lang.Object[] { new Long(GObject.new_with_params(cls, params)) };
          return (Object)cons.newInstance(args);
        } catch (NoSuchMethodException e) {
          // This should probably be some other kind of exception.
          // But, this really shouldn't happen.
          throw new RuntimeException("Proxy class " + cls.getName() + " malformed.");
        } catch(InstantiationException e) {
          throw new RuntimeException("Error creating " + cls.getName() + ": " + e.toString());
