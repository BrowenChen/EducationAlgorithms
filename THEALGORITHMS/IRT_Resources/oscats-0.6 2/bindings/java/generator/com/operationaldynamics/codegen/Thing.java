...
public abstract class Thing
{
     ...
     */
    protected Thing(String gtypeId, String gType, String javaPackage, String javaClass, String javaType,
    ...
    static {
        ...
        register(new ObjectThing("G_TYPE_OBJECT", "GObject*", "oscats.glib", "GObject", "Object"));
         ...
         */
        register(new ObjectThing(null, "Signal", "oscats.glib", "", "Signal"));
        register(new ObjectThing(null, "Proxy", "oscats.bindings", "", "Proxy"));
        register(new ObjectThing(null, "Blacklist", "oscats.bindings", "", "BlacklistedMethodError"));
        register(new ObjectThing(null, "FIXME", "oscats.bindings", "", "FIXME"));

        /*
         * Types needed for GError management
         */
        register(new GErrorThing());
        register(new ObjectThing(null, "GlibException", "oscats.glib", "", "GlibException"));
