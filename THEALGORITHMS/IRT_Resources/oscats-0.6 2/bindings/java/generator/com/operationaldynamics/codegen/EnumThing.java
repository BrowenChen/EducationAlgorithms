...
{
    public EnumThing(String gtypeId, String gType, String javaPackage, String javaClass, String javaType) {
        super(gtypeId, gType, javaPackage, javaClass, javaType, "int", "jint");
    }
